		...
		<table class="table table-bordered">
			<tr class="pc">
				<td colspan="2" align="right">
					<a href="<c:url value='/board/cat/${categoryId}/${page}'/>">
					...
					<a href="<c:url value='/board/reply/${board.boardId}'/>">
						<button type="button" class="btn btn-info">
					...
					<a href="<c:url value='/board/delete/${board.boardId}'/>">
						<button type="button" class="btn btn-info">
			...
			<tr>
				<td><fmt:message key="WRITE_DATE"/></td>
			...
			<tr>
				...
				<c:if test="${(filetype eq '.JPG') or (filetype eq 'JPEG') or (filetype eq '.PNG') or (filetype eq '.GIF')}">
					<img src="<c:url value='/file/${board.fileId}'/>" class="img-thumbnail"/><br>
				</c:if>
				<a href="<c:url value='/file/${board.fileId}'/>">
					${board.fileName} (<fmt:formatNumber>${board.fileSize}</fmt:formatNumber>byte)
				</a>
				</td>
			</tr>
			</c:if>
