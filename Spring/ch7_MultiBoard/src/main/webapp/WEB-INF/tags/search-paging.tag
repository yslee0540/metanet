...
if (nowPageBlock > 1) {
	out.print("<li>");
	out.print("<a href=\"" + contextPath + "/board/search/" + (startPage-1) + 
			"?keyword=" + keyword + "\" aria-label=\"Previous\">");
	out.print("◀</a>");
	out.print("</li>");
}
for (int i = startPage; i <= endPage; i++) {
	...
	out.print("<a href=\"" + contextPath + "/board/search/" + (i) + 
			"?keyword=" + keyword + "\">");
	out.print(i);
	out.print("</a>");
	out.print("</li>");
...
if (nowPageBlock < totalPageBlock) {
	out.print("<li>");
	out.print("<a href=\"" + contextPath + "/board/search/" + (endPage+1) + 
			"?keyword=" + keyword + "\" aria-label=\"Next\">");
	out.print("▶</a>");
	out.print("</li>");
}
out.println("</ul>");
