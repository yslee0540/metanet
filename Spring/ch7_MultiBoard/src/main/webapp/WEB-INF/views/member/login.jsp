	...
	<div class="pg-opt">
		<div class="row">
			<div class="col-md-6 pc">
				<h2><fmt:message key="LOGIN"/>
				<small style="color:red"><fmt:message key="${not empty message ? message : 'BLANK'}"/></small></h2>
			</div>
			<div class="col-md-6">
				<ol class="breadcrumb">
			...
			<form action="<c:url value='/member/login'/>" method="post" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						...
						placeholder="<fmt:message key="MEMBER_PW"/>" required>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-8 col-sm-offset-2">
						...
						<a href="<c:url value='/member/insert'/>" class="btn btn-success">
